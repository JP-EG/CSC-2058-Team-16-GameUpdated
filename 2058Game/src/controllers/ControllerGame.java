...
import controllers.ControllerHelpers.YesButtonAssignPlayer;
...
public class ControllerGame extends Main {
	...
	public void yesButtonAssignPlayer() {
		...
		YesButtonAssignPlayer yesButtonAssignPlayer = new YesButtonAssignPlayer(
			currentPlayer,
			assignedPlayer,
			tasks,
			square2, square3, square5,
			square6, square8, square9,
			square11, square12, square14,
			square15, square17, square18, square20);
